// complile using: g++ 03_triangle_v3.cpp -o 03_triangle_v3 -framework OpenGL -framework GLUT -lglew
...
int main(int argc, char ** argv)
{
   ...
   coordAttribute = getAttributeLocation(openGLProgramObject, "coord");
